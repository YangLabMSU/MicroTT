...
ElasticPath = "K:\Yang Research\Two-Photon Polymerization\Tensile Testing Data\Second Paper\Cyclic Data - v3 - Analyzed\Substrate 9-05-23_TD 10-18-23\16" ; % \Processed Data.mat" ;
...
Time = ElasticData.ProcessedData.Time;
Stress = ElasticData.ProcessedData.Stress-ElasticData.ProcessedData.Stress(1);
PlateStrain = ElasticData.ProcessedData.PlateStrain-ElasticData.ProcessedData.PlateStrain(1);
FiberStrain = ElasticData.ProcessedData.FiberStrain-ElasticData.ProcessedData.FiberStrain(1);
...
for i = 0:length(TrIdx)-1
    if i == 0
        ...
        segmentStress = Stress(1:TrIdx(1));
        ...
        % Segment data for each cycle
        segmentStress = Stress(TrIdx(i):TrIdx(i+1)-1);
...
fileName6 = 'MidRange_StressStrain_v3';
