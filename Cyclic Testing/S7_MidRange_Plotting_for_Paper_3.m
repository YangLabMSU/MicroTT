...
Path = "K:\Yang Research\Two-Photon Polymerization\Tensile Testing Data\Second Paper\Cyclic Data - v3 - Analyzed\Substrate 9-05-23_TD 10-18-23\16" ; % \Processed Data.mat" ;
...
for i = 0:length(TrIdx)-1
    if i == 0
        ...
        plot(segmentTime, smooth(segmentStress), 'Color', cmap(1, :), 'LineWidth', 4, ...
        ...
        % Plot for Fiber Strain
        plot(segmentTime, smooth(segmentStress), 'Color', cmap(i, :), 'LineWidth', 4, ...
             'DisplayName', sprintf('Cycle %d (Fiber)', i));
    end
end
