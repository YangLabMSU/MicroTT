...
load('Average Stretch Experiments Fits - v2.mat') ;
...
Header = [ "Writing Power (mW)" DetHead(:, 2) "Design Width x Height (um)" "Slice x Hatch (um)" DetHead(:,7:end) "First Modulus" "Second Modulus" "First Strain Coefficient" "Third Modulus" "Second Strain Coefficient" ] ; 
MatOut = [ Header ; MatOut ] ; 

AveragedStretchExpsDataTable = MatOut ; 
save("Averaged Stretch Experiments Data Table", "AveragedStretchExpsDataTable") ; 
