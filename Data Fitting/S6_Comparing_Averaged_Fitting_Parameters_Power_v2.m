...
for n = 3 %1:1:3 %:size(CompDataTable)
    ...
    newFolder = 'Dissertation - Power Comparisons' ;
    ...
    % fileName1 = Details2+'_Fig1_v3'+'.tiff';
    % fileName2 = Details2+'_Fig2_v3'+'.tiff';
    % fileName3 = Details2+'_Fig3_v3'+'.tiff';
    % path = cd ;
