function customBoxPlot_VectorMeasurements_HATSLC(powerData)
...
for i = 1:length(uniquePowers)
    dataCell{i} = double(powerData(powerData(:, 1) == uniquePowers(i), 2));
end
...
customBoxPlot_withStats_ForPaper_v8(dataCell) ; 
