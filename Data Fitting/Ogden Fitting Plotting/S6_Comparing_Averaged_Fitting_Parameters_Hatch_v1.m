...
for n = 1:size(CompDataTable)
    ...
    TickLabels = [ "Perp.", "Angled", "Parallel" ] ; 
    TickLabels = TickLabels(Sort) ;

    for nn = Sort % 1:size(mu,2)
    ...
    PlotSavePath = "K:\Yang Research\Two-Photon Polymerization\Analysis Code\DIC v12 - 4-26-24\Data Fitting\Ogden Fitting Plotting\Hatch Direction" ;
    ...
    Details2 = sprintf("%s_Power-%s_Speed-%s_Wxh-%sx%s_SxH-%sx%s_SR-%s", ...
        ConstantParamsKeep(n,[1 2 3 4 5 6 7 8])) ;
