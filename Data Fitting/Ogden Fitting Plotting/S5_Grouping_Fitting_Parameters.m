...
load('Average Ogden Experiments - v1 - Data.mat') ;
...
% 
%         if ~isempty(StretchExperimentData{MRidx, 4})
% 
%             paramData = StretchExperimentData{MRidx, 4};
%             if size(paramData, 2) == 3
% 
%                 Parameters(nn, 1:3) = paramData;
%                 Parameters(nn, 4:5) = strings(1, 2);  % Fill the remaining with empty strings
%                 YieldData(nn,:) = StretchExperimentData{MRidx, 5} ;
% 
