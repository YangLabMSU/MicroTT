...
for n = 1:size(CompDataTableNew)
    ...
    text(4.25, 75, 'Yield Stress, \sigma_y', 'FontSize', 14, 'FontWeight', 'bold', 'HorizontalAlignment', 'center') ;
    ax = gca;
    ...
    text(4.75, 1650, '\mu_1', 'FontSize', 18, 'FontWeight', 'bold', 'HorizontalAlignment', 'center') ;
    ax = gca;
    ax.Box = 'on';  % Turn on the box
    set(ax, 'BoxStyle', 'full');  % Ensure the box is drawn on all sides
    ax.LineWidth = 1.25 ; % Increase the axis line width
    ...
    text(4.5, -370, '\mu_2', 'FontSize', 18, 'FontWeight', 'bold', 'HorizontalAlignment', 'center') ;
    ax = gca;
    ax.Box = 'on';  % Turn on the box
    set(ax, 'BoxStyle', 'full');  % Ensure the box is drawn on all sides
    ax.LineWidth = 1.25 ; % Increase the axis line width
    ...
    text(4.5, -15, '\alpha_1', 'FontSize', 18, 'FontWeight', 'bold', 'HorizontalAlignment', 'center') ;
    ax = gca;
    ax.Box = 'on';  % Turn on the box
    set(ax, 'BoxStyle', 'full');  % Ensure the box is drawn on all sides
    ax.LineWidth = 1.25 ; % Increase the axis line width
    ...
    text(4.5, 8.5, '\alpha_2', 'FontSize', 18, 'FontWeight', 'bold', 'HorizontalAlignment', 'center') ;
    ax = gca;
    ax.Box = 'on';  % Turn on the box
    set(ax, 'BoxStyle', 'full');  % Ensure the box is drawn on all sides
    ax.LineWidth = 1.25 ; % Increase the axis line width
