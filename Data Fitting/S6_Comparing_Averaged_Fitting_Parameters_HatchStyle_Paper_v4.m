...
for n = 1 %:size(CompDataTable)
    ...
    customBoxPlot_withStats_v11(YSCell) ;
    ylim([15 45]) ;
    ...
    customBoxPlot_withStats_v11(Mods1Cell) ;
    ylim([300 940]) ;
    ...
    customBoxPlot_withStats_v11(Mods2Cell) ;
    ylim([0.3 0.6]) ;
    ...
    customBoxPlot_withStats_v11(Mods3Cell) ;
    ylim([1 2]) ;
    ...
    %subplot(1, 2, 1) ;
    customBoxPlot_withStats_v11(Lam1Cell) ;
    ylim([0.15 0.3]) ;
    ...
    customBoxPlot_withStats_v11(Lam2Cell) ;
    ylim([0.8 1.4]) ;
