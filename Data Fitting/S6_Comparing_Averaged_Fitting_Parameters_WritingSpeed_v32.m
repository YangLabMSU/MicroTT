...
for n = 1:size(CompDataTable)
    ...
    fig1 = figure('units', 'inches', 'Position', [ 13.5, 5, 9, 5 ]); hold on;
    ...
    % subplot(1,3,1) ;
    fig2 = figure('units', 'inches', 'Position', [ 13.5, 5, 9, 5 ]); hold on;
    ...
    % subplot(1,3,2) ;
    fig3 = figure('units', 'inches', 'Position', [ 13.5, 5, 9, 5 ]); hold on;
    ...
    % subplot(1,3,3) ;
    fig4 = figure('units', 'inches', 'Position', [ 13.5, 5, 9, 5 ]); hold on;
    ...
    % subplot(1, 2, 1) ;
    fig5 = figure('units', 'inches', 'Position', [ 13.5, 5, 9, 5 ]); hold on;
    ...
    newFolder = 'Dissertation - Write Speed Comparisons' ;
