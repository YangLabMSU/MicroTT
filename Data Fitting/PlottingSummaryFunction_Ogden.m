function PlottingSummaryFunction_Ogden(Stress, Strain, lambda, Parameters, CriticalPts, FittingValues, GoodnessOfFit)
...
newFolder = 'Ogden Fitting Summaries - IP-S - v3' ;
