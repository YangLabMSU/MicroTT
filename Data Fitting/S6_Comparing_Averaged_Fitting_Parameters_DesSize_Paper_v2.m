...
for n = 1 %:size(CompDataTable)
    ...
    TickLabels = CompDataTable{n,2} + " um" ;
    ...
    path = "K:\Advancing TPP Paper - v2\Figure Folder\Figure 6 - Fiber Design Size" ;
    PlotSize = [15, 5, 5.3*3, 3*3] ; 
    TitleFontSize = 18 ; 
    TextFontSize = 20 ; 
