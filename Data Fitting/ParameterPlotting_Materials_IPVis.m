...
YSCell{1,1} = IPVisioFitValues(:,7) ;
Mods1Cell{1,1} = IPVisioFitValues(:,1) ;
Mods2Cell{1,1} = IPVisioFitValues(:,2) ;
Mods3Cell{1,1} = IPVisioFitValues(:,4) ;
Lam1Cell{1,1} = IPVisioFitValues(:,3) ;
Lam2Cell{1,1} = IPVisioFitValues(:,5) ;
...
newFolder = 'Dissertation - IPVisio Evaluation' ;
