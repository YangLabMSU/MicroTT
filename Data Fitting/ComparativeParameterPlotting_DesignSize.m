function ComparativeParameterPlotting_DesignSize(ComparisonData)
...
for n = 1:size(sort_index,1) 
    ...
    LegendString(n,1) = sprintf("w x h: %s, SEM Area: %s", string(Variables(n,1)), string(SEMArea(n,1))) ; 
