...
for n = [9 22] %:size(DataDirectory,1)
    ...
    % Check Data Lengths 
    if length(Data.TopStructure.SumDisplacementY) ~= length(Data.Time)

        Data.Time = Data.Time(1:length(Data.TopStructure.SumDisplacementY)) ; 
        disp("Here"); 
