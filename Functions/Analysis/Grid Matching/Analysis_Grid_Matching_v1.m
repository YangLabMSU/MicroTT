function [ROI_Out, Data] = Analysis_Grid_Matching_v1(CurrentFrame, InitialGridBW, LastFrameBW, ROI, PixelRange, NPDRange)
...
while Check == 0
    ...
    if min(NPDAP) < NPDRange || min(NPDAN) < NPDRange || NPDI < NPDRange
        Check = 1 ;
    elseif PixDif < 25
        PixStart = PixEnd ;
