function [NPD] = GridScan_BW_Horizontal_v0(InitialGridBW, NextImage, ROI, PixelDiff)

% Set-Up Grid from ROI
GridYVector = ROI(1,1):1:ROI(2,1) ;
GridXVector = ROI(1,2):1:ROI(2,2) ;

% Adjust the X-Grid Vector
GridXVector = GridXVector - PixelDiff  ;
...
NextGrid = HM_Binarize_v0(NextGrid, InitialGridBW, 0) ; 
