...
% Folder, Parameter, and Grid Generation
...
%selectedFolder = 'K:\Yang Research\Two-Photon Polymerization\Tensile Testing Data\Second Paper\Data v2\Substrate 9-05-23_TD 10-18-23' ; 
...
if isempty(excelFiles)
    ...
    excelFileName = fullfile(selectedFolder, excelFiles(TPPTTExcelCheck).name);
...
for i = 1 %1:1:NumberExperiments
    ...
    Grids = Auto_SetWBPixelRatio_v3(Grids, AutoTemplate) ; % Automated Black-White Image Conversion
