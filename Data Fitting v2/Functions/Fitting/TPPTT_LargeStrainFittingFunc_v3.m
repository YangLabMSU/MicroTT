function [FittingValues, GoodnessOfFit] = TPPTT_LargeStrainFittingFunc_v3(InitialGuess, FitParameters, Stress, Strain) 
...
problem.objective = @(x)PolymerEquations3_v2(x, FitParameters, Stress, Strain) ;
problem.x0 = x0 ;
