...
load('All IP-S Fatigue Experiment Table - v2.mat') ;
...
parametercolumns = [1 3 8 9 10 11 12 13 14 18] ;
dataPathColumn = 27 ;
...
for i = 1:size(uniqueParams, 1)
    ...
    AveragedStretchExps{i, 2} = StressData ; 
    AveragedStretchExps{i, 3} = StrainData ; 
    AveragedStretchExps{i, 4} =  [ AvgStress StdStress ] ; 
    AveragedStretchExps{i, 5} = [ AvgStrain StdStrain ] ; 

end

%save("Average Stretch IP-S Fatigue Experiment", "AveragedStretchExps") ;
